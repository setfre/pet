...
<style>
	...
	.table-search,.table-search input,.cells-label{
		float: left;
	}
	.table-search{
		margin-right:4px;
	...
	.pagination,.pagination-index,.pagination-redirect{
		float:right;
	}
	.cells{
		float: left;
			...
			<div class="show-nab">
				...
				<div class="show-nab-group">
					<div class="show-nab-link">
						<a href="http://localhost:8080/pet/petResourse/toPetshop.action">宠物商品</a>
					</div>
					<div class="show-nab-link">
						<a href="#">我的宠物</a>
					</div>
				...
				<div class="show-nab-active show-nab-group">
					<c:if test="${user == null}">
						<div class="show-nab-link">
							<a href="http://localhost:8080/pet/userResourse/toLogin.action">登录</a>/
						</div>
						
						<div class="show-nab-link">
							<a href="http://localhost:8080/pet/userResourse/toLogin.action">注册</a>
						</div>
					</c:if>
					<c:if test="${user != null}">
						<!--头像 -->
						...
						<div class="show-nab-link">
							<a class="show-nab-link" href="http://localhost:8080/pet/userResourse/doExit.action">登出</a>
						</div>
					</c:if>
				</div>
			</div>
						...
						<div class="table-responsive"> 
							<table class="table table-hover table-striped">
								<thead> 
									...
									<tr>
										<th colspan="11">
											<form action="http://localhost:8080/pet/petResourse/doRetrievePetByKey.action" method="post"> 
										...
										<tr>
											...
											<th>
												<c:if test="${empty user || user.roleId == 1}">
													<c:if test="${empty pet.adoptTime}">
														<a href="http://localhost:8080/pet/petResourse/user/doAdoptPet.action?petId=${pet.id}&masterId=${user.id}">领养</a>
													</c:if>
													<c:if test="${!empty pet.adoptTime}">
														<a>已被领养</a>
													</c:if>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<a href="http://localhost:8080/pet/petResourse/doDeletePet.action"></a>
...
<div class="modal fade" id="addPet">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="http://localhost:8080/pet/petResourse/doCreatePet.action">
				<div class="modal-header">
...
<div class="modal fade" id="addPetType">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="http://localhost:8080/pet/petResourse/doCreatePetType.action">
				<div class="modal-header">
					<div class="modal-title"></div>
					 <button type="button" class="close" data-dismiss="modal">&times;</button>
				</div>
